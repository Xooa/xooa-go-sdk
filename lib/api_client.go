...
// XooaClient manages communication with the Xooa Blockchain API&#39;s API vv1
// In most cases there should be only one, shared, XooaClient.
...
func NewXooaClient(cfg *Configuration) (*XooaClient) {
	...
	c.InvokeApi = (*InvokeApiService)(&c.common)
	c.QueryApi = (*QueryApiService)(&c.common)
	c.ResultApi = (*ResultApiService)(&c.common)
...
func (c *XooaClient) callAPI(request *http.Request) (*http.Response, error) {
...
func (c *XooaClient) prepareRequest(
ctx context.Context,
...
fileBytes []byte) (localVarRequest *http.Request, err error) {
	...
	if ctx != nil {
		...
		localVarRequest.Header.Add("Authorization", "Bearer " + Token)
